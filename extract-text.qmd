...
Unforunately, downloading the titles as explained in chapter 2 is not the final step in getting the data ready to be downloaded. If you download and extract a single .zip file, you'll see the newspapers themselves are not simply a set of text files ready to use.
