...
The full documentation for alto2text is available via [Github](https://github.com/Living-with-machines/alto2txt). It uses the python programming language, and expects the newspapers the folder format in which they can be downloaded from the [Shared Research Repository](https://bl.iro.bl.uk/).
